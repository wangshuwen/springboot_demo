...
public class PageDto {
    ...
    public PageDto(Integer page, Integer rp) {
        super();
        this.page = page;
        this.rp = rp;
    }

    public PageDto(Integer page, Integer rp, String sortName) {
        super();
        this.page = page;
        this.rp = rp;
    ...
    public PageDto(Integer page, Integer rp, String sortName, String sortOrder) {
        super();
        this.page = page;
        this.rp = rp;
        this.sortName = sortName;
    ...
    public static PageDto createMaxPageDto() {
        PageDto pageDto = new PageDto();
        pageDto.setRp(MAX_PAGE_SIZE).setPage(1);
        return pageDto;
    }

    public static PageDto generateFlexiPageDto(Integer page, Integer rp, String orderBy) {
        PageDto pageDto = new PageDto(page, rp);
    ...
    public PageDto setRp(Integer rp) {
        this.rp = rp;
        return this;
    }
    ...
    public PageDto setPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public PageDto setSortName(String sortName) {
        this.sortName = sortName;
        return this;
    }
    ...
    public PageDto setSortOrder(String sortOrder) {
        this.sortOrder = sortOrder;
        return this;
    }
    ...
    public PageDto setRowCount(Integer rowCount) {
